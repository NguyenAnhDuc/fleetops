...
export default class LayoutFleetOpsSidebarComponent extends Component {
    ...
    createMenuPanels() {
        ...
        const resourcesItems = [
            ...
            // {
            //     intl: 'fleet-ops.component.layout.fleet-ops-sidebar.accounting-reports',
            //     title: this.intl.t('fleet-ops.component.layout.fleet-ops-sidebar.accounting-reports'),
            //     icon: 'file-invoice',
            //     route: 'management.accounting-reports',
            //     permission: 'fleet-ops list accounting-report',
            //     visible: this.abilities.can('fleet-ops see accounting-report'),
            // },
        ];
