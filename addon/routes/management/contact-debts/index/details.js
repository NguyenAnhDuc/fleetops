...
export default class ManagementContactDebtsIndexDetailsRoute extends Route {
    @service store;
    ...
    model({ public_id }) {
        return this.store.queryRecord('contact-debt', { public_id, single: true, with: ['driver', 'vehicle', 'reporter'] });
    }
}
